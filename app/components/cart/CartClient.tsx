...
const CartClient = () => {
    ...
    return (
        <div className="my-3 md:my-10">
            <PageContainer>
                <div className="flex items-center gap-3 text-center border-zinc-400 border-b py-3">
                ...
                <div className="flex items-center justify-between my-5 py-5 border-t border-zinc-400">
                    <button onClick={() => removeCart()} className="w-1/5 underline text-sm">Sepeti Sil</button>
                    <div className="text-lg md:text-2lg font-bold">{cartPrdctsTotal}</div>
                </div>
            </PageContainer>
        </div>
    )
